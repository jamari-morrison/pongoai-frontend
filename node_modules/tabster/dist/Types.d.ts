...
export declare type DeloserConstructor = (tabster: TabsterInternal, element: HTMLElement, props: DeloserProps) => Deloser;
...
export declare type FindFirstProps = Pick<FindFocusableProps, 'container' | 'includeProgrammaticallyFocusable' | 'ignoreGroupper' | 'ignoreUncontrolled' | 'ignoreAccessibiliy'>;
export declare type FindNextProps = Pick<FindFocusableProps, 'currentElement' | 'container' | 'includeProgrammaticallyFocusable' | 'ignoreGroupper' | 'ignoreUncontrolled' | 'ignoreAccessibiliy' | 'onUncontrolled'>;
export declare type FindDefaultProps = Pick<FindFocusableProps, 'container' | 'includeProgrammaticallyFocusable' | 'ignoreGroupper' | 'ignoreAccessibiliy'>;
export declare type FindAllProps = Pick<FindFocusableProps, 'container' | 'includeProgrammaticallyFocusable' | 'ignoreGroupper' | 'acceptCondition' | 'ignoreUncontrolled' | 'ignoreAccessibiliy'> & {
    container: HTMLElement;
...
export declare type MoverConstructor = (tabster: TabsterInternal, element: HTMLElement, props: MoverProps) => Mover;
...
export declare type GroupperConstructor = (tabster: TabsterInternal, element: HTMLElement, props: GroupperProps) => Groupper;
...
export declare type ModalizerConstructor = (tabster: TabsterInternal, element: HTMLElement, props: ModalizerProps) => Modalizer;
...
export declare type RootConstructor = (tabster: TabsterInternal, element: HTMLElement, props: RootProps) => Root;
