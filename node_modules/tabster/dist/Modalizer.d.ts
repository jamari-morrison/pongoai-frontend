...
export declare class Modalizer extends TabsterPart<Types.ModalizerProps> implements Types.Modalizer {
    ...
    constructor(tabster: Types.TabsterInternal, element: HTMLElement, onDispose: (modalizer: Modalizer) => void, moveOutWithDefault: (backwards: boolean) => void, onActiveChange: (active: boolean) => void, props: Types.ModalizerProps);
    private _onKeyDown;
...
export declare class ModalizerAPI implements Types.ModalizerAPI {
    ...
    static updateModalizer(tabster: Types.TabsterInternal, modalizer: Types.Modalizer, removed?: boolean): void;
    /**
