...
import { createKeyborg, disposeKeyborg, KEYBORG_FOCUSIN, nativeFocus } from 'keyborg';
...
var KeyboardNavigationState = /*#__PURE__*/function (_super) {
  ...
  function KeyboardNavigationState(getWindow) {
    ...
    _this._keyborg = createKeyborg(getWindow());
...
var RootDummyManager = /*#__PURE__*/function (_super) {
  __extends(RootDummyManager, _super);
...
var FocusableAPI = /*#__PURE__*/function () {
  ...
  FocusableAPI.prototype.findFirst = function (options) {
    return this.findElement(__assign({
  ...
  FocusableAPI.prototype.findDefault = function (options) {
    ...
    return this.findElement(__assign(__assign({}, options), {
...
var FocusedElementState = /*#__PURE__*/function (_super) {
  ...
  function FocusedElementState(tabster, getWindow) {
    ...
    _this._init = function () {
      ...
      win.document.addEventListener(KEYBORG_FOCUSIN, _this._onFocusIn, true);
  ...
  FocusedElementState.prototype.focusFirst = function (props) {
    ...
    if (!toFocus) {
      ...
      if (!toFocus) {
        toFocus = this._tabster.focusable.findFirst(__assign(__assign({}, props), {
  ...
  FocusedElementState.prototype.focusLast = function (props) {
    ...
    if (!toFocus) {
      ...
      if (!toFocus) {
        toFocus = this._tabster.focusable.findLast(__assign(__assign({}, props), {
          ignoreUncontrolled: true,
          ignoreAccessibiliy: true
        }));
      }
...
var GroupperDummyManager = /*#__PURE__*/function (_super) {
  __extends(GroupperDummyManager, _super);
...
var ModalizerAPIDummyManager = /*#__PURE__*/function (_super) {
  __extends(ModalizerAPIDummyManager, _super);
...
var MoverDummyManager = /*#__PURE__*/function (_super) {
  __extends(MoverDummyManager, _super);
...
export { Types, createTabster, disposeTabster, forceCleanup, getCrossOrigin, getCurrentTabster, getDeloser, getGroupper, getInternal, getModalizer, getMover, getObservedElement, getOutline, getTabsterAttribute, isNoOp, makeNoOp, setBasics as overrideBasics, setTabsterAttribute };
