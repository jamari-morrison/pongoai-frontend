...
export const useTextStyles = (state) => {
    ...
    state.root.className = mergeClasses(styles.root, styles[state.font], styles[state.weight], styles[state.size], state.italic && styles.italic, state.underline && styles.underline, state.strikethrough && styles.strikethrough, state.underline && state.strikethrough && styles.strikethroughUnderline, styles[(state.color + 'Color')], state.root.className);
    return state;
};
