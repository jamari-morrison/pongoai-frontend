...
export const usePasswordState = (state) => {
    ...
    //  Prefix Props
    !state.disabled &&
        (state.showIconWrapper.children = (React.createElement(Button, { className: "pongoai-Password-show-button", appearance: "subtle", shape: "circular", onClick: onButtonPointerDown }, isPasswordVisible ? React.createElement(PasswordHideIcon, null) : React.createElement(PasswordShowIcon, null))));
    // Border Props
