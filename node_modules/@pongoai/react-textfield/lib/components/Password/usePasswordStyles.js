...
import { useRootStyles, useInputStyles, useInputWrapperStyles, useTextFieldBorderStyles, useLabelStyles, useTextFieldLegendStyles, useTextFieldWrapperStyles, useHelperTextStyles, textFieldBorderClassName, labelClassName, legendClassName, } from '../TextField/index';
...
export const usePasswordStyles = (state) => {
    ...
    state.input.className = mergeClasses(inputStyles.input, inputStyles.prefix, state.label && state.placeholder && inputStyles.labelPlaceholderFocus, (state.appearance === 'filled' || state.appearance === 'standard') && inputStyles.lowerTextAlignment, state.disabled && inputStyles.disabled, state.input.className);
    state.showIconWrapper.className = mergeClasses(showIconStyles.container, (state.appearance === 'filled' || state.appearance === 'standard') && showIconStyles.lowerTextAlignment, state.disabled && showIconStyles.disabled, state.input.value === '' && showIconStyles.passwordIconVisible, showIconStyles.icon, showIconStyles.focusIndicator, state.showIconWrapper.className);
    ...
    state.textFieldLabel.className = mergeClasses(labelClassName, labelStyles.label, !state.disabled ? labelStyles.enabled : labelStyles.disabled, state.error && labelStyles.error, state.input.value !== '' && (state.label !== undefined ? labelStyles[state.appearance] : labelStyles.placeholder), state.textFieldLabel.className);
    state.textFieldLegend.className = mergeClasses(legendClassName, textFieldLegendStyles.textFieldLegend, state.input.value !== '' ? textFieldLegendStyles.active : textFieldLegendStyles.inactive, state.textFieldLegend.className);
};
