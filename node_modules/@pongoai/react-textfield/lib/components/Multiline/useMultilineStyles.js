...
import { useHelperTextStyles, useRootStyles, useTextFieldBorderStyles, textFieldBorderClassName, legendClassName, useInputStyles, useLabelStyles, labelClassName, } from '../TextField/index';
...
export const useMultilineStyles = (state) => {
    ...
    state.root.className = mergeClasses(multilineRootStyles.root, rootStyles.focusIndicator, !state.error && !state.disabled && rootStyles.inputFocus, state.label !== undefined && rootStyles[state.appearance], state.root.className);
    ...
    state.textFieldLegend.className = mergeClasses(legendClassName, textFieldLegendStyles.textFieldLegend, state.textarea.value !== '' ? textFieldLegendStyles.active : textFieldLegendStyles.inactive, state.textFieldLegend.className);
};
