...
import { useRootStyles, useInputStyles, useTextFieldBorderStyles, useLabelStyles, useTextFieldLegendStyles, useTextFieldWrapperStyles, useHelperTextStyles, textFieldBorderClassName, labelClassName, legendClassName, useSuffixPrefixStyles, } from '../TextField/index';
...
export const useSelectStyles = (state) => {
    ...
    state.selectButton.className = mergeClasses(selectButtonStyles.selectButton, (state.appearance === 'filled' || state.appearance === 'standard') && inputStyles.lowerTextAlignment, state.disabled && inputStyles.disabled, state.selectButton.className);
    state.list.className = mergeClasses(listStyles.list, listStyles.inactiveListItem, listStyles.activeListItem, state.disabled ? listStyles.disabled : listStyles.enabled, state.list.className);
    state.input.className = mergeClasses(selectInputStyles.input, state.input.className);
    state.textFieldWrapper.className = mergeClasses(textFieldWrapperStyles.wrapper, state.disabled ? selectWrapperStyles.disabled : selectWrapperStyles.enabled, state.textFieldWrapper.className);
    ...
    state.textFieldLabel.className = mergeClasses(labelClassName, labelStyles.label, !state.disabled ? labelStyles.enabled : labelStyles.disabled, state.error && labelStyles.error, labelStyles[state.appearance], state.textFieldLabel.className);
    state.textFieldLegend.className = mergeClasses(legendClassName, textFieldLegendStyles.textFieldLegend, textFieldLegendStyles.active, state.textFieldLegend.className);
};
