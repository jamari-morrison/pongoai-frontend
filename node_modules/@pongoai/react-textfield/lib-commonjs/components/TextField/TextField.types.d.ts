...
export declare type TextFieldSlots = {
    /**
...
export declare type TextFieldCommons = {
    /**
...
export declare type TextFieldProps = Omit<ComponentProps<TextFieldSlots>, 'onChange' | 'defaultValue'> & TextFieldCommons;
export declare type TextFieldState = ComponentState<TextFieldSlots> & TextFieldCommons;
