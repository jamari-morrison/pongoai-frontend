...
import { activeStarClassName, inactiveStarClassName, disabledActiveStarClassName, disabledInactiveStarClassName, } from './useRatingState';
...
export const useRatingStyles = (state) => {
    const rootStyles = useRootStyles();
    const starWrapperStyles = useStarStyles();
    const inputStyles = useInputStyle();
    state.root.className = mergeClasses(rootStyles.root, rootStyles[state.size], !state.disabled && rootStyles.focusIndicator, !state.readOnly && (state.disabled ? rootStyles.disabled : rootStyles.enabled), state.root.className);
    state.starWrapper.className = mergeClasses(starWrapperStyles.star, !state.readOnly && !state.disabled && starWrapperStyles.enabledStar, state.starWrapper.className);
