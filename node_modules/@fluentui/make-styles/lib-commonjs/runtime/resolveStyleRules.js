  ...
  for (var property in styles) {
    ...
    if (typeof value === 'string' || typeof value === 'number') {
      ...
      for (var _i = 0, animationNames_1 = animationNames; _i < animationNames_1.length; _i++) {
        ...
        var keyframe = compileKeyframeCSS_1.compileKeyframeRule(val);
        var name_1 = constants_1.HASH_PREFIX + hash_1.default(keyframe);
        keyframeCSS += compileKeyframeCSS_1.compileKeyframesCSS(name_1, keyframe);
        names.push(name_1);
        var rtlKeyframe = compileKeyframeCSS_1.compileKeyframeRule(core_1.convert(val));

        if (keyframe !== rtlKeyframe) {
          var nameRtl = constants_1.HASH_PREFIX + hash_1.default(rtlKeyframe);
          keyframeRtlCSS += compileKeyframeCSS_1.compileKeyframesCSS(nameRtl, rtlKeyframe);
